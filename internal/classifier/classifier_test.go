...
func TestClassifyNextAsDevServer(t *testing.T) {
	...
	assertClassification(t, got, "dev-server", app.ConfidenceHigh)
...
func TestClassifyStorybook(t *testing.T) {
	...
	assertClassification(t, got, "storybook", app.ConfidenceHigh)
...
func TestClassifyAgentBrowser(t *testing.T) {
	...
	assertClassification(t, got, "agent", app.ConfidenceHigh)
...
func TestClassifyBrowser(t *testing.T) {
	...
	assertClassification(t, got, "browser", app.ConfidenceMedium)
...
func TestClassifyUnknownUnderUserSites(t *testing.T) {
	...
	assertClassification(t, got, "unknown", app.ConfidenceLow)
	assertHasEvidence(t, got, "/Users/")
}

func assertClassification(t *testing.T, got Classification, label string, confidence app.Confidence) {
	t.Helper()
	if got.Label != label {
